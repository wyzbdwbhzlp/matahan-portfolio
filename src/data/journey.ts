...
export const journeyItems: JourneyItem[] = [
	...
	},
	{
		...
		dateColumnClass: 'md:text-right md:pr-12 mb-4 md:mb-0',
		dateClass: 'ember-text font-mono font-bold text-base md:text-lg uppercase tracking-wide',
		date: { i18nKey: 'j3.date', fallback: '2026.07 - 至今' },
		status: { i18nKey: 'j3.status', fallback: '实习进行中' },
		cardColumnClass: 'md:pl-12',
		cardClass: 'glass-card p-6 border-4 border-aurora-green',
		tags: [
			{ i18nKey: 'j3.tag1', fallback: 'HoYoverse', className: 'tag-ember' },
			{ i18nKey: 'j3.tag2', fallback: '绝区零' },
		],
		title: { i18nKey: 'j3.title', fallback: '《绝区零》项目组实习' },
		description: {
			i18nKey: 'j3.desc',
			fallbackHtml:
				'2026 年 7 月初加入米哈游<span class="font-semibold text-ink-900">《绝区零》项目组</span>实习，在正式项目生产环境中继续积累游戏研发协作与落地经验。',
		},
	},
	{
		id: 'future',
		...
		date: { i18nKey: 'j4.date', fallback: '2026 - ?' },
		status: { i18nKey: 'j4.status', fallback: '永远在路上' },
		cardColumnClass: 'md:text-right md:pr-12 mb-4 md:mb-0 order-2 md:order-1',
		cardInnerClass: 'md:pl-12',
		cardClass: 'glass-card p-6 border-4 border-aurora-violet',
		tags: [
			{ i18nKey: 'j4.tag1', fallback: 'In Progress' },
			{ i18nKey: 'j4.tag2', fallback: '∞' },
		],
		title: { i18nKey: 'j4.title', fallback: 'Keep Playing, Keep Creating' },
		description: {
			i18nKey: 'j4.desc',
			fallbackHtml:
